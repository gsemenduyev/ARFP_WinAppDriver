...
// URL("http://127.0.0.1:4723"), capability);
...
// File file = new File("C:\\Program Files (x86)\\Windows Application
// Driver\\WinAppDriver.exe");
...
// capability.setCapability("platformName", "Windows");
// capability.setCapability("deviceName", "Windows10Machine");
// winDriver1 = new WindowsDriver<WindowsElement>(new
// URL("http://127.0.0.1:4723"), capability);
//
...
// applicationWindow.get().getAttribute("NativeWindowHandle");
