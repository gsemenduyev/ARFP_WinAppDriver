...
report.generate({
    jsonDir: 'cypress/reports/sbms-arfp-stratasphere-report',
    ...
    customData: {
        ...
        data: [
            ...
            { label: 'Node Version', value: runInfo['nodeVersion'] },
            {
                ...
                value: dayjs(runInfo['startedTestsAt']).format('YYYY-MM-DD HH:mm:ss'),
            },
            {
                label: 'Execution End Time',
                value: dayjs(runInfo['endedTestsAt']).format('YYYY-MM-DD HH:mm:ss'),
            },
        ],
    },
    disableLog: true,
